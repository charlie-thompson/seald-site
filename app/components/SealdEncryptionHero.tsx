          ...
          {PLAINTEXT_ROWS.map((row, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  {isEncrypted ? <><img src="/images/seald_icon.svg" alt="Seald Healthcare | Encrypted Status Icon" style={{ width: 14, height: 14, display: 'inline-block', verticalAlign: 'middle', marginRight: 2 }} /> Seald</> : "⚠ Open"}
                </span>
              </div>
            );
          })}
