...
<section className="relative overflow-hidden bg-white py-24 md:py-32 lg:py-40">
  ...
  <Container className="relative z-10">
    <div className="flex flex-col items-center md:flex-row md:items-center md:justify-between">
      ...
      <div className="my-6 flex h-[500px] w-full items-center justify-center overflow-hidden md:my-0 md:h-auto md:w-[540px] md:max-w-[45vw] md:shrink-0 md:grow-0 md:ml-8">
        <SealdEncryptionHero />
      </div>
    </div>
  </Container>
